...
public:
    ...
    */
    ...
    virtual void PrintToStr(std::string& voStr, int depth) const {
        printf("error: PrintToStr do nothing.\n");
    }
#endif
...
#ifdef TIXML_USE_STL
    virtual void PrintToStr(std::string& voStr, int depth) const override;
#endif
...
public:
    ...
    */
    ...
    void SaveSvgStr(std::string& svgStr) const;
    void PrintToStr(std::string& svgStr, int depth) const;
#endif
